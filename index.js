...
```
console.error(
  'ERROR AL GUARDAR logsConfig.json:',
  error
);
```
...
try {
  ...
  // Evita sanciones repetidas inmediatamente
  ...
  await message.channel.send({
    ...
    content:
      '🚨 <@' +
      message.author.id +
      '> fue silenciado durante **10 minutos** por spam.'
  ...
  if (
    ...
    if (
      ...
      if (
        ...
        await interaction.reply({
          content:
            '❌ Necesitas permiso de **Gestionar servidor** para usar este comando.',
          ephemeral: true
        });
    ...
    if (
      ...
      if (
        ...
        await interaction.reply({
          content:
            '❌ Necesitas permiso de **Gestionar roles** para usar este comando.',
          ephemeral: true
        });
    ...
    if (
      ...
      if (
        ...
        await interaction.reply({
          content:
            '❌ Necesitas permiso de **Gestionar canales** para usar este comando.',
          ephemeral: true
        });
